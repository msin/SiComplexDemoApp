...
namespace IoCApp
{
    ...
    public partial class App
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            var window = IoC.Instance.GetInstance<DXRibbonWindow>();
        ...
        private void Bootstrap()
        {
            ...
            IoC.Instance.Params.Add("LogLevel", IoCApp.Properties.Settings.Default.LogLevelFile);

            //  Look for assemblies with project prefix and interface IPackage
            IoC.Instance.RegisterPackages("IocApp.");
